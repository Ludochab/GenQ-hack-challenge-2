...
from kings_graph import king_graph, remove_random_nodes, add_random_edge_weights_sum, draw_edge_weights
from OtherMaxCut import maxcut_goemans_williamson
import math
import random
import numpy as np

M = 4          # number of lines in the grid
N = 4         # number of columns in the grid
...
bin_size = 0.5  # Choose your bin size (e.g., 5 units)
...
with open("classical_kings_smol.json", "w") as f:
